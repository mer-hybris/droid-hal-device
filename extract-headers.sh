...
/* This file brings in the android global configurations
   which are not visible from headers.
   eg COMMON_GLOBAL_CFLAGS settings
   Typically it is generated by the hardware adaptation
*/
